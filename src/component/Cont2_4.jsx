...
export default function Cont2_4(props) {
    const { article1, article2, article3, article4, article5, article6, hoverColor,maxdesc , maxtit } = props;
  ...
  return (
    <div className="container2_4">
        ...
        <Horicard
            ...
            cardTitle={article3 &&  article3.title? article3.title.substring(0,maxtit/1.5)+ " ..."  : ""}
        ...
        <Horicard
            ...
            cardTitle={article4 &&  article4.title? article4.title.substring(0,maxtit/1.5)+ " ..."  : ""}
        ...
        <div className="rightside">
            ...
            cardTitle={article5 &&  article5.title? article5.title.substring(0,maxtit/1.5)+ " ..."  : ""}
            ...
            cardTitle={article6 &&  article6.title? article6.title.substring(0,maxtit/1.5)+ " ..."  : ""}
